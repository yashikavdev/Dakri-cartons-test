    ...
    <div style={{ display: "flex" }}>
      ...
      >
        <h2 style={{ fontWeight: "bold" }}>
          <span style={{paddingRight: "15px"}}>{getBarIcon(title)}</span>
          <span>{title}</span>
        </h2>
        <table style={{ borderSpacing: "0", width: "100%" }}>
          <thead>
            <tr>
              ...
              >
                {title === "Restock Items"? "Tool/Equipment" : "Team Member"}
              </th>
              {title !== "Missing Items" && (
                <th
                  style={{
                ...
                >
                  ...
                  {title == "Rental Tools"? "Status" : "Stock Status"}
                </th>
              )}
              <th
                style={{
          ...
          <tbody>
            {list?.map((item: ListItem) => (
              <tr key={item.id}>
                ...
                >
                  { title === "Restock Items"? item.tool : item.teamMember}
                </td>
                {title !== "Missing Items" && (
                  <td
                    style={{
